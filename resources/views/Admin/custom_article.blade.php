...
<div class=" flex flex-col  items-center min-h-[100vh] lg:min-h-[87vh] shadow bg-[#DCDCDC]">
    ...
    <div class="mt-10">
       <h3 class="font_title_first">Ajouter un article</h3>
    </div>
    @if ($errors)
    ...
    <form action="{{ route('create')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex flex-row justify-between  items-center mb-2 mt-10">
            <label for="titre" class="mx-2 Placeholder lg:w-1/2">Titre</label>
        ...
        <div class="flex flex-row  justify-between items-center mb-2 ">
            ...
            <label for="description" class="mx-2 Placeholder lg:w-1/2">Description</label>
        ...
        <div class="flex flex-row justify-between items-center mb-2">
            <label for="article1" class="mx-2 Placeholder w-1/3  lg:w-1/2">Id Article lié n°1</label>
            <input name="article1" type="text" class="border px-2 rounded-md focus:outline-none  focus:border-[#4287f5]" >
        </div>
        <div class="flex flex-row justify-between items-center mb-2">
            <label for="article2" class="mx-2 Placeholder lg:w-1/2">Id Article lié n°2</label>
            <input name="article2" type="text" class="border px-2 rounded-md focus:outline-none  focus:border-[#4287f5]">
        </div>
        <div class="flex flex-row justify-between items-center mb-2">
            <label for="article3" class="mx-2 Placeholder lg:w-1/2">Id Article lié n°3</label>
            <input name="article3" type="text" class="border px-2 rounded-md focus:outline-none  focus:border-[#4287f5]">
        </div>
        <div class="flex flex-row justify-between items-center mb-2">
            <label for="format" class="mx-2 Placeholder lg:w-1/2">Format de l'article</label>
            <select name="format" id="" class="p-2 border-[#4287f5] rounded-md focus:outline-none  focus:border-[#4287f5]" required>

                <option value="valeur1" class="mx-8 Placeholder">Image</option>
                <option value="valeur2" class="mx-8 Placeholder"">Video</option>
                <option value="valeur3" class="mx-8 Placeholder"">Poadcast</option>
                <option value="valeur4" class="mx-8 Placeholder"">Image && Poadcast</option>

            </select>
        </div>
        <div class="flex flex-row justify-between items-center mb-2">
            <label for="categorie" class="mx-2 Placeholder lg:w-1/2">Catégorie</label>
        ...
        <div class="flex flex-row justify-between items-center mb-2" required>
            <label for="file" class="mx-2 Placeholder lg:w-1/2" required>Fichier</label>
        ...
        <div>
            <button class="p-2 bg-blue-400 border-2 w-80 border-blue-400" type="submit">
                Publier l'article
            </button>
        </div>  
